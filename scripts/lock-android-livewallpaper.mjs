 ...
 * Validates the new package layout: com.aetherx.livewallpaper(.wallpaper)
 */
...
if (manifest.includes("com.aetherx.localfinal")) {
  fail("AndroidManifest.xml still references legacy package com.aetherx.localfinal");
}

console.log("[AetherX Lock] Live wallpaper wiring verified (com.aetherx.livewallpaper).");
